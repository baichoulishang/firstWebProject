...
<html class="x-admin-sm">
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/core/Xadmin/css/font.css">
        <link rel="stylesheet" href="${pageContext.request.contextPath}/core/Xadmin/css/xadmin.css">
        <!-- <link rel="stylesheet" href="./css/theme5.css"> -->
        <script src="${pageContext.request.contextPath}/core/layui/layui.js" charset="utf-8"></script>
        <script src="${pageContext.request.contextPath}/core/Xadmin/js/xadmin.js" charset="utf-8"></script>
        <!-- 让IE8/9支持媒体查询，从而兼容栅格 -->
        <!--[if lt IE 9]>
    ...
    <body class="index">
        ...
        <div class="container">
            <div class="logo">
                <a href="${pageContext.request.contextPath}">返回首页</a></div>
            <div class="left_open">
            ...
            <div id="side-nav">
                <ul id="nav">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('平时常用的','${pageContext.request.contextPath}/my/index.do')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>平时常用的</cite></a>
                            </li>
                            <li>
                                <a onclick="xadmin.add_tab('测试layui页面','${pageContext.request.contextPath}/my/layuiTest.do')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>测试layui页面</cite></a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript:;">
                            <i class="iconfont left-nav-li" lay-tips="图表们">&#xe723;</i>
                            <cite>图表们</cite>
                            <i class="iconfont nav_right">&#xe697;</i></a>
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('图表示例','${pageContext.request.contextPath}/echarts/main.do')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>图表首页</cite></a>
                            </li>
                        </ul>
